...
def get_mouse_position():
    input("Turn on Shutter. Hover your mouse over the blue portion of the Shutter button and press 'Enter': ")
...
def main():
    ...
    if update_required:
        ...
        save_to_json(json_file, {'position': position, 'shutter_on': shutter_on})
    else:
