...
WT_raw = eliminiate_nan(rna_signal(:, [1, 2]));
WT = signal_normalization(WT_raw, wavenumber_samples);

MUT_raw = eliminiate_nan(rna_signal(:, [1, 3])); 
...
L_Dopamine_Raw = readmatrix('L Dopamine Raw.txt');
L_Dopamine = signal_normalization(L_Dopamine_Raw, wavenumber_samples);

DL_Norepinephrine_hcl_Raw = readmatrix('DL Norepinephrine hcl Raw.txt');
DL_Norepinephrine_hcl = signal_normalization(DL_Norepinephrine_hcl_Raw, wavenumber_samples);
...
subtype_name = ["PE", "PLS", "Cholesterol","Cholesterol_ester", "Cardiolipin", "Sphingosine" ...
                ...
                "deoxy dihydro cer 18,0_14,0", "deoxy dihydro cer 18,0_24,1", "L_Dopamine","DL_Norepinephrine_hcl"];
reference_dataset = {PE, PLS, Cholesterol, Cholesterol_ester, Cardiolipin, Sphingosine ...
                     ...
                     deoxycer_dihydro_cer_18_0_14_0, deoxycer_dihydro_cer_18_0_24_1,L_Dopamine,DL_Norepinephrine_hcl};
