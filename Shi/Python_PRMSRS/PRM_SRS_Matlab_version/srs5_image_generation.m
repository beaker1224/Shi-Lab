...
root_folder = "D:\Chrome\Rapamycin\data\brain\L3\1-CH"; % now 
% you can put a full absolute path here
% you will find your files under the same subfolder with a folder called
% CH***_out
disp(root_folder)
folder_names = folders_generation(root_folder);

output_folder = strcat(root_folder, "_lipid_subtype_output/"); mkdir(output_folder);

wavenumber_samples = linspace(2700, 3120, 62); % raman shift begin, raman shift end, number of images
